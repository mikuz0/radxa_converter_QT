...
QT_MOC_LITERAL(1, 15, 13), // "profileLoaded"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 14), // "EncoderProfile"
QT_MOC_LITERAL(4, 45, 7), // "profile"
QT_MOC_LITERAL(5, 53, 13), // "onSaveProfile"
QT_MOC_LITERAL(6, 67, 13), // "onLoadProfile"
QT_MOC_LITERAL(7, 81, 15), // "onDeleteProfile"
QT_MOC_LITERAL(8, 97, 15), // "onExportProfile"
QT_MOC_LITERAL(9, 113, 15), // "onImportProfile"
QT_MOC_LITERAL(10, 129, 22) // "onItemSelectionChanged"

    },
    "ProfilesDialog\0profileLoaded\0\0"
    "EncoderProfile\0profile\0onSaveProfile\0"
    "onLoadProfile\0onDeleteProfile\0"
    "onExportProfile\0onImportProfile\0"
...
void ProfilesDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->profileLoaded((*reinterpret_cast< const EncoderProfile(*)>(_a[1]))); break;
        case 1: _t->onSaveProfile(); break;
        case 2: _t->onLoadProfile(); break;
        case 3: _t->onDeleteProfile(); break;
        case 4: _t->onExportProfile(); break;
        case 5: _t->onImportProfile(); break;
        ...
        {
            using _t = void (ProfilesDialog::*)(const EncoderProfile & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProfilesDialog::profileLoaded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProfilesDialog::profileLoaded(const EncoderProfile & _t1)
{
