...
QT_MOC_LITERAL(5, 53, 10) // "logMessage"

    },
    "SSHClient\0connectionStatusChanged\0\0"
    "connected\0message\0logMessage"
};
...
void SSHClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SSHClient *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SSHClient::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SSHClient::connectionStatusChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SSHClient::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SSHClient::logMessage)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SSHClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_SSHClient.data,
    qt_meta_data_SSHClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SSHClient::connectionStatusChanged(bool _t1, const QString & _t2)
{
...
// SIGNAL 1
void SSHClient::logMessage(const QString & _t1)
{
